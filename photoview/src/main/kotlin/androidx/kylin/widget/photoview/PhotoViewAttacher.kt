...
import androidx.kylin.widget.photoview.Compat.postOnAnimation
import androidx.kylin.widget.photoview.Util.checkZoomLevels
import androidx.kylin.widget.photoview.Util.hasDrawable
import androidx.kylin.widget.photoview.Util.isSupportedScaleType
    ...
    override fun onTouch(v: View, ev: MotionEvent): Boolean {
        ...
        if (isZoomEnabled && hasDrawable((v as ImageView))) {
            ...
            if (dragDetector != null) {
                val wasScaling = dragDetector.isScaling
                val wasDragging = dragDetector.isDragging
                handled = dragDetector.onTouchEvent(ev)
                val didntScale = !wasScaling && !dragDetector.isScaling
                val didntDrag = !wasDragging && !dragDetector.isDragging
